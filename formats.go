...
var formats = map[string]Format{
	...
	"ID": {
		...
		Regions: NewRegionMap(
			...
			"PB", "Papua Barat", "PD", "Papua Barat Daya", "PE", "Papua Pengunungan",
			"PS", "Papua Selatan", "PT", "Papua Tengah", "RI", "Riau",
			"SR", "Sulawesi Barat", "SN", "Sulawesi Selatan", "ST", "Sulawesi Tengah",
			"SG", "Sulawesi Tenggara", "SA", "Sulawesi Utara", "SB", "Sumatera Barat",
			"SS", "Sumatera Selatan", "SU", "Sumatera Utara",
		),
	},
	"IE": {
		Layout:            "%1\n%2\n%3\n%S\n%L\n%R\n%P",
	...
	"IT": {
		...
		Regions: NewRegionMap(
			...
			"FR", "Frosinone", "OT", "Gallura Nord-Est Sardegna", "GE", "Genova",
			...
			"OG", "Ogliastra", "OR", "Oristano", "PD", "Padova",
			...
			"SR", "Siracusa", "SO", "Sondrio", "SU", "Sulcis Iglesiente",
	...
	"PH": {
		...
		Regions: NewRegionMap(
			...
			"MGN", "Maguindanao del Norte", "MGS", "Maguindanao del Sur", "MAD", "Marinduque",
			"MAS", "Masbate", "00", "Metro Manila", "MSC", "Misamis Occidental",
			"MSR", "Misamis Oriental", "MOU", "Mountain Province", "NEC", "Negros Occidental",
			"NER", "Negros Oriental", "NSA", "Northern Samar", "NUE", "Nueva Ecija",
			"NUV", "Nueva Vizcaya", "MDC", "Occidental Mindoro", "MDR", "Oriental Mindoro",
			"PLW", "Palawan", "PAM", "Pampanga", "PAN", "Pangasinan",
			"QUE", "Quezon", "QUI", "Quirino", "RIZ", "Rizal",
			"ROM", "Romblon", "WSA", "Samar", "SAR", "Sarangani",
			"SIG", "Siquijor", "SOR", "Sorsogon", "SCO", "South Cotabato",
			"SLE", "Southern Leyte", "SUK", "Sultan Kudarat", "SLU", "Sulu",
			"SUN", "Surigao del Norte", "SUR", "Surigao del Sur", "TAR", "Tarlac",
			"TAW", "Tawi-Tawi", "ZMB", "Zambales", "ZAN", "Zamboanga del Norte",
			"ZAS", "Zamboanga del Sur", "ZSI", "Zamboanga Sibuguey",
		),
	},
	"PK": {
		Layout:            "%1\n%2\n%3\n%L-%P",
	...
	"VE": {
		...
		Regions: NewRegionMap(
			...
			"W", "Dependencias Federales", "A", "Distrito Capital", "I", "Falcón",
			"J", "Guárico", "X", "La Guaira", "K", "Lara",
			"M", "Miranda", "N", "Monagas", "L", "Mérida",
			"O", "Nueva Esparta", "P", "Portuguesa", "R", "Sucre",
			"T", "Trujillo", "S", "Táchira", "U", "Yaracuy",
			"V", "Zulia",
		),
	},
	"VG": {
