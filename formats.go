...
var formats = map[string]Format{
	...
	"CA": {
		...
		LocalRegions: NewRegionMap(
			...
			"MB", "Manitoba", "NB", "Nouveau-Brunswick", "NS", "Nouvelle-Écosse",
			"NU", "Nunavut", "ON", "Ontario", "QC", "Québec",
			"SK", "Saskatchewan", "NL", "Terre-Neuve-et-Labrador", "NT", "Territoires du Nord-Ouest",
			"YT", "Yukon",
		),
	},
	"CC": {
