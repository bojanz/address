...
var formats = map[string]Format{
	...
	"RU": {
		...
		LocalRegions: NewRegionMap(
			...
			"TY", "Республика Тыва", "KK", "Республика Хакасия", "ROS", "Ростовская область",
			"RYA", "Рязанская область", "SAM", "Самарская область", "SPE", "Санкт-Петербург",
			"SAR", "Саратовская область", "SAK", "Сахалинская область", "SVE", "Свердловская область",
			"SMO", "Смоленская область", "STA", "Ставропольский край", "TAM", "Тамбовская область",
			"TVE", "Тверская область", "TOM", "Томская область", "TUL", "Тульская область",
