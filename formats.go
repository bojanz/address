...
var formats = map[string]Format{
	...
	"PH": {
		...
		Regions: NewRegionMap(
			...
			"00", "Metro Manila", "MSC", "Misamis Occidental", "MSR", "Misamis Oriental",
			"MOU", "Mountain Province", "NEC", "Negros Occidental", "NER", "Negros Oriental",
			"NSA", "Northern Samar", "NUE", "Nueva Ecija", "NUV", "Nueva Vizcaya",
			"MDC", "Occidental Mindoro", "MDR", "Oriental Mindoro", "PLW", "Palawan",
			"PAM", "Pampanga", "PAN", "Pangasinan", "QUE", "Quezon",
